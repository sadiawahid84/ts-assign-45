...
var travelDestintation = ["Istanbul", "Dubai", "Paris", "London", "NewYork"];
console.log("\nORIGINAL TRAVEL DESTINATION LIST:");
for (var i = 0; i < travelDestintation.length; i++) {
    console.log(travelDestintation[i]);
}
var originalTravelDestinaton = travelDestintation.slice();
...
for (var i = 0; i < originalTravelDestinaton.length; i++) {
    console.log(originalTravelDestinaton[i]);
}
travelDestintation.sort(function (a, b) { return b.localeCompare(a); });
