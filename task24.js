...
var itemToFind = "banana";
console.log("Is '".concat(itemToFind, "' in the array? I predict True."));
console.log(fruits.indexOf(itemToFind) !== -1); // True
var itemToFind2 = "peach";
console.log("Is '".concat(itemToFind2, "' not in the array? I predict True."));
